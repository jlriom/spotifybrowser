...
using SpotifyBrowser.User.ReadStack.Aplication;
...
using SpotifyBrowser.User.ReadStack.DataAccess.Implementation;
...
namespace SpotifyBrowser.User.ReadStack.Api.Host
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IAccountReadOnlyService, AccountReadOnlyService>();
            services.AddScoped<IUserReadOnlyService, UserReadOnlyService>();

            services.AddDbContext<SpotifyBrowserAccountsReadOnlyDbContext>(options =>
            ...
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                .AddJwtBearer(options =>
                {
                    ...
                    options.Audience = Constants.SpotifyBrowserReadUsersApiName;
                });
